        ...
        try {
            ...
            while(true) {
                ...
                if(result == 0){
					...
					out.flush();
                    File userFile = new File("C:\\Users\\Administrator\\Desktop\\接受文件\\" + userName);
                    if(!userFile.exists()) {  // 新建当前用户的文件夹
                        userFile.mkdir();
                    }
                    File file = new File("C:\\Users\\Administrator\\Desktop\\接受文件\\" + userName + "\\"+ textName);
                    ...
                    JOptionPane.showMessageDialog(chatViewJFrame, "文件存放地址：\n" +
                            "C:\\Users\\Administrator\\Desktop\\接受文件\\" +
