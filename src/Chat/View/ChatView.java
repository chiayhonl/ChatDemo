...
import Chat.Controller.ClienReadAndWriteThread;
import Chat.Controller.ClientFileThread;
...
public class ChatView {
    ...
    JTextField text;
    JTextArea textArea;
    ClienReadAndWriteThread.ChatViewListen listener;
    ...
    void init() {
        ...
        // 设置“发送”监听
        listener = new ClienReadAndWriteThread().new ChatViewListen();
