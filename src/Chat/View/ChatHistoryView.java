...
import Chat.Controller.ServerReandAndWriteThread;
...
public class  ChatHistoryView {
    JTextArea textArea;
    ServerReandAndWriteThread ServerReandAndWriteThread;
    ...
    public ChatHistoryView() {
        init();
        ServerReandAndWriteThread = new ServerReandAndWriteThread(this);
        ServerReandAndWriteThread.monitor();//调用监听方法
    }
